<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserInfo.aspx.vb" Inherits="Web.UserInfo" %>
...
<body>
    <form id="form1" class="registerform" runat="server" action="user/userjson.aspx">
        ...
        <input id="action" name="action" type="hidden" value="modinfo" />
    ...
    <li class="active">基本信息</li>
                      ...
                      <div class="span3">
                              <ul class="nav nav-tabs nav-list nav-stacked bs-docs-sidenav">
                                ...
                                <li><a href="userinfolist.aspx"><i class="icon-chevron-right"></i>我的作业</a></li>
                                  ...
                                  <li class="active"><a href="userinfo.aspx"><i class="icon-chevron-right"></i>个人信息设置</a></li>
          ...
          <legend>用户注册</legend>
            ...
            <div class="controls">
                <% If IsDBNull(userinfo.OtherGuid) Then
            ...
            <div class="controls">
                                    <input type="text" value="<%=userinfo.Truename%>" name="txt_truename" class="inputxt" datatype="*" errormsg="请输入姓名！" />
                   <span class="help-inline Validform_checktip">填写姓名</span>
            </div>
          </div>
                                     <div class="control-group">
            <label class="control-label" >QQ号码</label>
            <div class="controls">
 <input type="text" value="<%=userinfo.Qq%>" name="txt_qq" class="inputxt" />
                                   <span class="help-inline Validform_checktip">方便客户在线联系交流</span>
            </div>
          </div>
                                     <div class="control-group">
            <label class="control-label" >微信号码</label>
            <div class="controls">
<input type="text" value="<%=userinfo.Qqwx%>" name="txt_wx" class="inputxt" />
                                                   <span class="help-inline Validform_checktip"></span>
            </div>
          </div>
