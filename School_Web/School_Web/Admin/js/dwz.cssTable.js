				...
				$trs.hoverClass("hover").each(function(index){
					...
					$tr.click(function(){
						...
						if (sTarget) {
						    ...
						    $(".toolBar.edit", navTab.getCurrentPanel()).show();

						    $(".toolBar.delete", navTab.getCurrentPanel()).show();

						} else {
						    $(".toolBar.edit", navTab.getCurrentPanel()).hide();

						    $(".toolBar.delete", navTab.getCurrentPanel()).hide();
