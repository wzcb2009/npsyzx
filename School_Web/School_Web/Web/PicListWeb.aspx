<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PicListWeb.aspx.vb" Inherits="Web.PicListWeb" %>
...
<div class="pageHeader">
	<form   onsubmit="return navTabSearch(this);" action="../web/newslistweb.aspx" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="../web/newsInfoweb.aspx?action=add&caseid=<%=Request.QueryString("caseid")%>" target="navTab"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="../web/newsdo.aspx?action=btdel" class="delete"><span>批量删除</span></a></li>
			...
			<li><a class="edit" href="../comment/commentlistweb.aspx?parentid={sid_user}" target="dialog" warn="请选择一个新闻"><span>查看评论</span></a></li>
 		</ul>
	</div>
